...
@section('main-body')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="/juara/{{ $dataJuara->id }}" method="post">
                @method('put')
                @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="id_peserta" id="id_peserta" class="form-select @error('id_peserta') is-invalid @enderror" aria-describedby="validationPeserta">
                            @foreach ($dataPeserta as $rowPeserta)
                                @if (old('id_peserta', $dataJuara->id_peserta) == $rowPeserta->id)
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Input keterangan">{{ old('keterangan', $dataJuara->keterangan) }}</textarea>
                    </div>
                </div>
